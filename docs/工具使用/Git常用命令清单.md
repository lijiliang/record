...
git config --global user.name "Benson"           # 修改全局名字
git config --global user.email "1951828835@qq.com"  # 修改全局邮箱
...
```bash
ssh-keygen -t rsa -C '1951828835@qq.com' # 生成密钥  
ssh-keygen -t rsa -C "1951828835@qq.com" -f ~/.ssh/ww_rsa # 指定生成目录文件名字
