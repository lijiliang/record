...
```txt
http://localhost:3000/home?id=12&name=benson
``` 
...
运行代码，并通过浏览器访问 `http://localhost:3000/home?id=12&name=benson`，然后打开控制台会看到下面的输出内容： 
...
```txt
http://localhost:3000/home/12/benson
``` 
...
运行代码，并通过浏览器访问 `http://localhost:3000/home/12/benson`，然后查看下控制台显示的日志信息： 
